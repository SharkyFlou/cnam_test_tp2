...
{
    public class InterestTableCalculator : IInterestTableCalculator
    {
        private readonly Dictionary<InterestType, Dictionary<int, double>> InterestTable = new Dictionary<InterestType, Dictionary<int, double>>
        {
                [InterestType.GoodRate] = new Dictionary<int, double>
                {
                    [7] = 0.62,
                    [10] = 0.67,
                    [15] = 0.85,
                ...
                [InterestType.VeryGoodRate] = new Dictionary<int, double>
                {
                    [7] = 0.43,
                    [10] = 0.55,
                    [15] = 0.73,
                ...
                [InterestType.ExcellentRate] = new Dictionary<int, double>
                {
                    [7] = 0.35,
                    [10] = 0.45,
                    [15] = 0.58,
        ...
        private int RoundYears(int years)
        {
